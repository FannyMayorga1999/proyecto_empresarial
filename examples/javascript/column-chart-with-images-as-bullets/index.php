        ...
        $.miPlugin({
            am4charts: {
                data: <?php
                  ...
                  $fecha2 = '01-02-2019';
                  $limite = $_GET["limite"];
                  $consulta = "select accountname,answered, (avgcalltime::TIME-avganswertime::TIME) as tiempotimbrado ,avgcalltime  from coc_queue_report_agent_general(' $fecha1', ' $fecha2',0,0) order by answered desc limit $limite";
                  consulta($consulta); ?>,
                value_max: 300,
                axis_min: 70,
                axis_max: 50,
